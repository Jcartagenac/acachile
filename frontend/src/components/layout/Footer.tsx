            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-3 sm:space-x-4">
                <a
                  ...
                  className="w-12 h-12 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-2xl flex items-center justify-center shadow-soft-md hover:shadow-soft-lg border border-white/30 transition-all duration-300 transform hover:scale-110"
                >
