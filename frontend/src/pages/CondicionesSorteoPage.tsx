        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
            ...
            <section>
              ...
              <p>
                Al participar en el sorteo organizado por la Asociación de Chilenos en Achao (en adelante, "ACACHILE"), 
            ...
            <section>
              ...
              <div className="bg-gray-100 p-4 rounded-lg mt-4">
                <p><strong>Asociación de Chilenos en Achao (ACACHILE)</strong></p>
