    ...
    return (
      <div className="min-h-screen bg-soft-gradient-light flex items-center justify-center">
        <div className="rounded-3xl bg-white/70 backdrop-blur-md border border-white/60 shadow-soft-xl px-10 py-12 text-center">
          ...
          <p className="text-neutral-600">Debes iniciar sesión para crear eventos.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-neutral-900">Crear evento</h1>
              <p className="text-sm text-neutral-500">Publica actividades oficiales para la comunidad ACA</p>
            </div>
          </div>
          <button
            type="button"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                >
                  ...
                  {isLoading ? 'Guardando…' : 'Publicar evento'}
                </button>
                <button
                  type="button"
                  onClick={() => {
              ...
              <div className="rounded-3xl bg-white/70 backdrop-blur-md border border-white/60 shadow-soft-xl overflow-hidden">
                <div className="relative h-48 bg-neutral-200">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <h4 className="text-lg font-semibold">{watchedValues.title || 'Nuevo evento'}</h4>
                  </div>
                </div>
