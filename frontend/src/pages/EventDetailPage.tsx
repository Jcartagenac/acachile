      ...
      <div className="max-w-4xl mx-auto px-4 py-12 relative z-10">
        ...
        <div className="bg-white/60 backdrop-blur-soft border border-white/30 rounded-2xl shadow-soft-lg overflow-hidden mb-8">
          ...
          <div className="relative bg-neutral-100">
            ...
            {/* Botón Editar - solo visible para el organizador o admin - flotante en la imagen */}
            {user && (user.id === evento.organizerId || user.roles?.includes('admin')) && (
              <div className="absolute top-4 right-4">
                <button
                  onClick={() => navigate(`/eventos/${evento.id}/editar`)}
                  className="bg-white/90 hover:bg-white backdrop-blur-medium text-neutral-700 px-4 py-2 rounded-lg transition-all flex items-center gap-2 border border-white/30 shadow-soft-md hover:shadow-soft-lg"
                >
          ...
          {/* Título y badges debajo de la imagen */}
          <div className="p-6">
            <h1 className="text-3xl md:text-4xl font-bold mb-4 text-neutral-800">{evento.title}</h1>
            <div className="flex items-center space-x-4 text-sm">
              <span className="bg-primary-600 text-white px-3 py-1 rounded-full capitalize shadow-soft-sm">
                {evento.type}
              </span>
              <span className="bg-neutral-100 text-neutral-700 px-3 py-1 rounded-full shadow-soft-sm">
